...
if [ -d "/etc/nginx/" ]; then
    ...
    echo -e "\033[1;33mSkipping: No existing NGINX configuration to backup.\033[0m"
fi
...
if [ -d "/etc/php/" ]; then
    ...
    echo -e "\033[1;33mSkipping: No existing PHP configuration to backup.\033[0m"
fi
...
if [ -d "/etc/mysql/" ]; then
    ...
    echo -e "\033[1;33mSkipping: No existing MySQL configuration to backup.\033[0m"
fi
